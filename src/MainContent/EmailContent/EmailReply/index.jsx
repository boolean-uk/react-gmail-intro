        ...
        <div className='replyContainer container'>
            ...
            <div className='replyBox col-md-11'>
                ...
                <div className='replyBoxInput'>
                    <textarea className="textField" rows="4" cols="50" placeholder="Write text here"></textarea>
                </div>
                <div className='replyBoxFooter'>
                    <div><button id="sendButton">Send</button></div>
                    <div><img src={TextfieldTools} alt='tools' id="tools" /></div>
                    <div className='footerRubbishContainer'><img src={RubbishIcon} alt="rubbish" id="rubbish" /></div>
                </div>
            </div>
